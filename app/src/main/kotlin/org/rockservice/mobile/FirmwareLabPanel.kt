...
internal fun FirmwareLabPanel(
    ...
    Column(
        ...
        Text(
            "Selecione uma imagem para identificar o formato, calcular SHA-256 e executar os parsers estruturais disponiveis. Nenhum payload e gravado ou modificado automaticamente.",
        )
        Button(
